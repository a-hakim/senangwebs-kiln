...
var PropertyPanel = /*#__PURE__*/function (_EventEmitter) {
  ...
  return _createClass(PropertyPanel, [{
    ...
    key: "updateTransformFields",
    value: function updateTransformFields() {
...
var UIManager = /*#__PURE__*/function (_EventEmitter) {
  ...
  return _createClass(UIManager, [{
    ...
    value: function setupEventListeners() {
      ...
      this.swk.on('transformDragging', function () {
        if (_this3.propertyPanel) {
          _this3.propertyPanel.updateTransformFields();
        }
      });

      // Object transformation completed
      this.swk.on('objectTransformed', function () {
        if (_this3.propertyPanel) {
          _this3.propertyPanel.updateTransformFields();
        }
      });
